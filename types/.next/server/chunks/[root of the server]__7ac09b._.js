...
"[project]/app/api/getnode/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'data', 'nodedata', 'node.json');
    console.log("API hit");
    try {
        const data = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].promises.readFile(filePath, 'utf-8');
        console.log(data);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__7ac09b._.js.map